...
+ (void)checkInstancesNum
{
    if ([[NSRunningApplication runningApplicationsWithBundleIdentifier:[[NSBundle mainBundle] bundleIdentifier]] count] > 1) {
        [self RemindException:[NSString stringWithFormat:@"%@ is already running.",[[NSBundle mainBundle] objectForInfoDictionaryKey:(NSString *)kCFBundleNameKey]] Information:@"This copy will now quit"];
        [NSApp terminate:nil];
    }
}
